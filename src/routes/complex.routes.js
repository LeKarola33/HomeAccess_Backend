 ...
 */
router.get('/me', authorize('admin'), complexController.getMyComplex);
 ...
 */
router.get('/:id', authorize('admin'), complexController.getComplexById);
